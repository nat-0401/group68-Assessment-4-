    ...
    class AddDemeritPointsTests {
        ...
        public void testAddDemeritPoints1() {
            ...
            System.out.println("---testAddDemeritPoints1()---");
                ...
                Person person = new Person("55s_d%&fAB","15-05-2008","2024-01-01,3");
                String result = person.addDemeritPoints(filePath);

                //Test Data 2: month out of range
                Person person2 = new Person("56s_d%&fAB","29-05-2005","31-13-2023,2");
                String result2 = person2.addDemeritPoints(filePath);

                //Test Data 3: date > current date (future)
                Person person3 = new Person("57s_d%&fAB","28-05-2010","12-12-2028,4");
        ...
        public void testAddDemeritPoints2() {
            ...
            System.out.println("---testAddDemeritPoints2()---");
                ...
                Person person = new Person("55s_d%&fAB","15-05-2008","01-01-2024,0");
                String result = person.addDemeritPoints(filePath);

                //Test Data 2: points > 6
                Person person2 = new Person("56s_d%&fAB","29-05-2005","31-12-2023,7");
                String result2 = person2.addDemeritPoints(filePath);

                //Test Data 3: decimal
                Person person3 = new Person("57s_d%&fAB","28-05-2010","12-12-2023,5.5");
                String result3 = person3.addDemeritPoints(filePath);

                //Test Data 4: empty variable
                Person person4 = new Person("58s_d%&fAB","05-07-1999","12-12-2023");
        ...
        public void testAddDemeritPoints3() {            
            ...
            System.out.println("---testAddDemeritPoints3()---");
                ...
                Person person = new Person("55s_d%&fAB","15-05-2008","01-01-2020,3,01-02-2024,4");
                String result = person.addDemeritPoints(filePath);

                //Test Data 2: point <= 6
                Person person2 = new Person("56s_d%&fAB","29-05-2005","30-12-2023,2,6-03-2025,1,16-06-2024,1");
                String result2 = person2.addDemeritPoints(filePath);

                //Test Data 3: point == 6
                Person person3 = new Person("57s_d%&fAB","28-05-2011","12-12-2023,4,7-05-2024,2");
                String result3 = person3.addDemeritPoints(filePath);
        ...
        public void testAddDemeritPoints4() {
            ...
            System.out.println("---testAddDemeritPoints4()---");
                //Test Data 1: demerits not within 2 years
                Person person = new Person("55s_d%&fAB","15-05-2000","01-01-2020,6,01-02-2024,6,01-03-2024,1");
                String result = person.addDemeritPoints(filePath);

                //Test Data 2: point <= 12
                Person person2 = new Person("56s_d%&fAB","29-05-2003","31-12-2023,5,6-03-2025,2");
                String result2 = person2.addDemeritPoints(filePath);

                //Test Data 3: point == 12
                Person person3 = new Person("57s_d%&fAB","28-05-1997","12-12-2023,6,7-05-2024,6");
                String result3 = person3.addDemeritPoints(filePath);
        ...
        public void testAddDemeritPoints5() {
            ...
            System.out.println("---testAddDemeritPoints5()---");
                ...
                Person person = new Person("55s_d%&fAB","15-05-2000","01-01-2024,6,01-02-2024,6,01-03-2024,1");
                String result = person.addDemeritPoints(filePath);

                 //Test Data 2: point > 6, under 21
                Person person2 = new Person("56s_d%&fAB","29-05-2009","31-12-2023,5,6-03-2025,2");
                String result2 = person2.addDemeritPoints(filePath);
